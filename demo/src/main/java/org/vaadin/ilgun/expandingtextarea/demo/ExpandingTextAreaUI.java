...
public class ExpandingTextAreaUI extends UI {
    ...
    protected void init(VaadinRequest request) {
        ...
        expandingTextArea.addRowsChangeListener((RowsChangeListener) event -> rowsLabel.setValue("" + event.getRows()));

        final com.vaadin.v7.ui.CheckBox appendExtraRow = new com.vaadin.v7.ui.CheckBox("Append extra row", expandingTextArea.isAppendExtraRow());
        appendExtraRow.addValueChangeListener((Property.ValueChangeListener) event -> expandingTextArea.setAppendExtraRow(appendExtraRow.getValue()));
        content.addComponent(appendExtraRow);

        final com.vaadin.v7.ui.NativeSelect maxRows = new com.vaadin.v7.ui.NativeSelect("Max rows");
        maxRows.addValueChangeListener((Property.ValueChangeListener) valueChangeEvent -> expandingTextArea.setMaxRows((Integer) maxRows.getValue()));
        maxRows.addItem(2);
        maxRows.addItem(5);
        maxRows.addItem(10);
